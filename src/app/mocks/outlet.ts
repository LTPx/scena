  ...
  products: [
    {
      ...
      original_price: "499€",
      outlet_price: "349€",
      image: { url: "/images/outlet/beoplay-h100.png", alt: "Beoplay Portal" },
      ...
      gallery: [
        { url: "/images/outlet/beoplay-h100-1.png", alt: "Beoplay Portal Grey Mist frontal" },
        { url: "/images/outlet/beoplay-h100-2.png", alt: "Beoplay Portal Grey Mist lateral" },
        { url: "/images/outlet/beoplay-h100-3.png", alt: "Beoplay Portal Grey Mist detalle almohadillas" },
        { url: "/images/outlet/beoplay-h100-4.png", alt: "Beoplay Portal Grey Mist logo B&O" },
        { url: "/images/outlet/beoplay-h100-5.png", alt: "Beoplay Portal Grey Mist estuche" },
      ],
    },
    {
      id: 2,
      ...
      note: "*Iva, transporte e instalación incluido.",
      gallery: [
        { url: "/images/outlet/beosound-a9-1.png", alt: "Beosound A9 Natural Oak frontal" },
        { url: "/images/outlet/beosound-a9-2.png", alt: "Beosound A9 Natural Oak en salón" },
        { url: "/images/outlet/beosound-a9-3.png", alt: "Beosound A9 Natural Oak detalle textil" },
      ],
    },
    {
      id: 3,
      ...
      gallery: [
        { url: "/images/outlet/beoplay-ex-1.png", alt: "Beoplay EX Bronze Tone estuche abierto" },
        { url: "/images/outlet/beoplay-ex-2.png", alt: "Beoplay EX Bronze Tone auriculares" },
        { url: "/images/outlet/beoplay-ex-3.png", alt: "Beoplay EX Bronze Tone detalle logo" },
        { url: "/images/outlet/beoplay-ex-4.png", alt: "Beoplay EX Bronze Tone estuche cerrado" },
      ],
    },
    {
      id: 4,
      ...
      original_price: "890€",
      outlet_price: "590€",
      image: { url: "/images/outlet/lampara-pie.png", alt: "Lámpara de pie Arc" },
      ...
      note: "*Iva, transporte e instalación incluido.",
      gallery: [
        { url: "/images/outlet/lampara-pie-1.png", alt: "Lámpara de pie Arc completa" },
        { url: "/images/outlet/lampara-pie-2.png", alt: "Lámpara de pie Arc detalle base" },
        { url: "/images/outlet/lampara-pie-3.png", alt: "Lámpara de pie Arc encendida" },
      ],
    },
    {
      id: 5,
      ...
      outlet_price: "2.890€",
      image: { url: "/images/outlet/sofa-modular.png", alt: "Sofá modular Dune" },
      ...
      gallery: [
        { url: "/images/outlet/sofa-modular-1.png", alt: "Sofá modular Dune vista general" },
        { url: "/images/outlet/sofa-modular-2.png", alt: "Sofá modular Dune detalle tapizado" },
        { url: "/images/outlet/sofa-modular-3.png", alt: "Sofá modular Dune en salón" },
        { url: "/images/outlet/sofa-modular-4.png", alt: "Sofá modular Dune configuración chaise longue" },
        { url: "/images/outlet/sofa-modular-5.png", alt: "Sofá modular Dune detalle patas" },
      ],
    },
  ],
};